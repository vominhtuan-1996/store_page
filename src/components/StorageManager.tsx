    ...
    <div className="w-full">
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-accent-cyan/30 to-primary-500/30">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Quản lý file trên Supabase Storage</p>
          </div>
        </div>
