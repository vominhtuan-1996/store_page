...
const JournalSection: React.FC = () => {
  ...
  return (
    <section id="resume" style={{ background: 'hsl(var(--bg))', padding: '4rem 0 6rem' }}>
        ...
        <div className="flex flex-col gap-3">
          {ENTRIES.map((entry, i) => (
            <motion.article
              ...
              className="group flex items-center gap-6 p-4 rounded-[40px] sm:rounded-full cursor-pointer transition-all duration-300"
              style={{
